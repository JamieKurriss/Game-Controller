...
while True:
    ...
    # reads in x and y values from serial and decodes it from the utf format
    # if you don't decode from utf, then the numbers show up weird like -> 'b 528 /r/b'
    ...
    # x and y values go from 0-1023
    # 0 indicates left and up
    # 1023 indicates right and down
    ...
    GxX = ser.readline().decode('utf-8')
    print("GxX = " + GxX)
    GyY = ser.readline().decode('utf-8')
    print("GyY = " + GyY)
    
    # x and y values go from roughly -17000 to 1700
    # -5000 indicates up and right
    # 5000 indicates down and left
    # Depending on the sensitivity desired and numbers
    # can be chosen between -17000 and 17000
    
    #            -5000 Up
    #                |
    #                |
    #  Left 5000 --------- -5000 Right
    #                |
    #                |
    #            5000 Down
    ...
    if head.distance(food) < 20:
        ...
        #Write 'E' bit to the arduino via serial to signal Buzzer on
        ser.write(b'E')
